...
<head>
    ...
    <!-- Page Title -->
    <title>Livio Rodrigues - CV/Resume</title>
    <!-- Styles -->
...
<div class="content">
    ...
    <div class="menu">
        ...
        <div class="menu-content">
            <ul>
                <li><a class="active" href="#" data-value="about">SOBRE</a></li>
...
<!--                <li><a href="#" data-value="portfolio">PORTFOLIO</a></li>-->
                ...
                <li><a href="#" data-value="contact-us">CONTATO</a></li>
            </ul>
        </div>
        <div class="open-menu">
    ...
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="info-profile">
                            <h2><span>HI I'M</span> LIVIO RODRIGUES $$$$$$$$ CI </h2>
                                ...
                                <div class="col-sm-6">
                                    <ul class="ul-info">
                                        ...
                                        <li class="li-info">
                                            ...
                                            <span class="info">liviorodrigueslopes@gmail.com</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="ul-info">
                                        ...
                                        <li class="li-info">
                                            ...
                                            <span class="info">kaosteck.expert</span>
                                        </li>
                                        <li class="li-info">
        ...
        <section id="education" class="section section-education wow fadeInUp" data-wow-offset="40">
            <div class="header-section">
                <h2 class="h2-section">EDUCAÇÃO</h2>
            </div>
            <div class="row">
                <!-- single education -->
...
<!--        </section>-->
        ...
        <section id="interests" class="section section-interests wow fadeInUp" data-wow-offset="40">
            <div class="header-section">
                <h2 class="h2-section">INTERESSES</h2>
            </div>
            <div class="text-interests">
                <p>Apaixonado por esportes autdoors</p>
            </div>
                ...
                <div class="col-sm-5">
                    <div class="info-content">
                        ...
                        <div class="address">
                            ...
                            <span class="info-text">Ahgora Sistemas</span>
                        </div>
                        <div class="email">
                            <span class="info-icon"><i class="fa fa-envelope"></i></span>
                            <span class="info-text">liviorodrigueslopes@gmail.com</span>
                        </div>
                        <div class="telephone">
                            <span class="info-icon"><i class="fa fa-phone"></i></span>
                            <span class="info-text">Não Declarado</span>
                        </div>
                        <div class="website">
                            <span class="info-icon"><i class="fa fa-link"></i></span>
                            <span class="info-text">kaosteck.expert</span>
                        </div>
                    </div>
                </div>
            </div>
